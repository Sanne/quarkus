...
import io.quarkus.deployment.jvm.ReflectiveHackModulesReconfigurer;
...
public class StartupActionImpl implements StartupAction {
    ...
    //TODO: make such services generally reusable across live-reload restarts? (They bind to the JVM and are independent from the app)
    private final JvmModulesReconfigurer jvmModulesReconfigurer = new ReflectiveHackModulesReconfigurer();
