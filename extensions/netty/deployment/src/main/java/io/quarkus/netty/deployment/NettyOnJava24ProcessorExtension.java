...
public class NettyOnJava24ProcessorExtension {
    ...
    @BuildStep
    ModuleOpenBuildItem jdk24OpenNio() {
        return new ModuleOpenBuildItem("java.base/java.nio");
    }

    @BuildStep
    ModuleOpenBuildItem jdk24OpenJdkInternalMisc() {
        return new ModuleOpenBuildItem("java.base/jdk.internal.misc");
    }
