...
public final class SQLXLMFeature implements Feature {
    ...
    private void enableDomXMLProcessingInDriver(DuringAnalysisAccess duringAnalysisAccess) {
        final Class<?> classByName = duringAnalysisAccess.findClassByName("io.quarkus.jdbc.postgresql.runtime.graal.PgSQLXML");
        try {
            final Method method = classByName.getMethod("reallyProcessAsDomResult");
