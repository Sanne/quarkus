 ...
 * this switches the internal cache implementation (currently used for some stats and, crucially, for the {@link org.hibernate.query.spi.QueryInterpretationCache}
 * to use Caffeine rather than the legacy implementation Hibernate ORM normally uses, which is based on the excellent LIRS algorithm but which we
 * plan to deprecate in favour of modern caching libraries.
 * See also <a href="https://en.wikipedia.org/wiki/LIRS_caching_algorithm">LIRS</a> and <a href="https://github.com/ben-manes/caffeine/wiki/Efficiency">Caffeine, efficiency</a>.
 */
