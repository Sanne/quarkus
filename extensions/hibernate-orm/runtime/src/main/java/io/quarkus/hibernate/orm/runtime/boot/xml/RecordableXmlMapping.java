...
public class RecordableXmlMapping {
    ...
    /*
     * @RecordableConstructor public RecordableXmlMapping(JaxbEntityMappings
     * ormXmlRoot, JaxbHbmHibernateMapping hbmXmlRoot, SourceType originType, String
     * originName) { this.ormXmlRoot = ormXmlRoot; this.hbmXmlRoot = hbmXmlRoot;
     * this.originType = originType; this.originName = originName; }
     */
    ...
    /*
     * public JaxbEntityMappings getOrmXmlRoot() { return ormXmlRoot; }
     */

    public JaxbHbmHibernateMapping getHbmXmlRoot() {
        return null; //hbmXmlRoot;
    }

    public SourceType getOriginType() {
        return null; //originType;
    }

    public String getOriginName() {
        return null; //originName;
    }
    /*
     * public Binding<?> toHibernateOrmBinding() { Origin origin = new
     * Origin(originType, originName); if (ormXmlRoot != null) { return new
     * Binding<>(ormXmlRoot, origin); } else { return new Binding<>(hbmXmlRoot,
     * origin); } }
     */
}
